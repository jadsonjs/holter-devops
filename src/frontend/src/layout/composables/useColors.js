 ...
 * 
 * Configuracoes das cores da aplicação
 * 
 */
import { ref } from 'vue';
...
export const primaryColors = ref([
	// definir aqui a palleta do IMD https://www.color-hex.com/color/3662a1
	{ name: 'imd', palette: { 50: '#d6dfec', 100: '#c2cfe2', 200: '#9ab0d0', 300: '#7291bd', 400: '#3662a1', 500: '#3662a1', 600: '#3662a1', 700: '#3662a1', 800: '#3662a1', 900: '#3662a1', 950: '#3662a1' } },
...
const { layoutConfig, setPrimary, setSurface, setPreset} = useLayout();
...
/*
* Atualiza as cores quando o usuário seleciona uma cor 
*/
...
/*
* Aplica as cores selecionado ao primevue
*/
